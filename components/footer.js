            ...
            <div className="flex flex-col justify-evenly md:flex-row">
                <div className="w-5/6 md:w-1/4 md:mr-6 md:mt-0 mt-10">
                    <div className="mb-10">
                        ...
                        <p className="mt-2">
                        <Link href="/about"><a className="uppercase font-bold hover:text-custom-flamingo">Learn more &rarr;</a></Link>
                        </p>
                    </div>
                    <Socials />
                </div>
                ...
                <div className="w-5/6 md:w-1/4 flex flex-col md:mt-0 mt-10">
                    ...
                    <Link href="/contact#calendly"><a className="mt-4 uppercase font-bold hover:text-custom-flamingo">Let's connect! &rarr;</a></Link>
                </div>
